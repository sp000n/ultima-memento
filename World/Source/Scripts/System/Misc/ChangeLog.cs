...
namespace Server.Misc
{
    class ChangeLog
    {
		...
		public static string Versions()
        {
			...
			builder.Append("       - Added breakpoints to bypass RNG at 20/40/60 skill<br>");
			...
			builder.Append("         At 40+ skill, both items will be guaranteed<br>");
			builder.Append("       - Scenario - 5 items drop<br>");
			builder.Append("         At 20 skill, 1 item will be guaranteed<br>");
			builder.Append("           The other items will have a 20/125 chance to drop<br>");
			builder.Append("         At 40 skill, 2 items will be guaranteed<br>");
			builder.Append("           The other items will have a 40/125 chance to drop<br>");
			...
			builder.Append("         At 80 skill, 3 items will be guaranteed<br>");
