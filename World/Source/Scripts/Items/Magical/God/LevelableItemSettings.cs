namespace Server
{
	public class LevelItems
	{
        ...
        public static readonly int DefaultMaxLevel = 40; //Default Max level for items.
        public static readonly int MaxLevelsCap = 40; //Number of total levels items can go up to when maxed.
