...
{
	public class ShantyRemoveTarget : Target
	{
		private readonly BaseHouse m_House;

		public ShantyRemoveTarget(BaseHouse house) : base(-1, true, TargetFlags.None)
		{
			m_House = house;
		}
		...
		protected override void OnTarget(Mobile from, object targeted)
		{
			...
			var item = targeted as ShantyItem;
			if (item == null)
			...
			from.Target = new ShantyRemoveTarget(m_House);
		}
	}
}