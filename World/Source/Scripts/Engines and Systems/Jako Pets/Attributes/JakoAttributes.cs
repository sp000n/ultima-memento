...
namespace Custom.Jerbal.Jako
{
    ...
    public class JakoAttributes
    {
        ...
        {
            m_attributes.Add(JakoAttributesEnum.Hits, new JakoHitPointsAttribute());
            m_attributes.Add(JakoAttributesEnum.Stam, new JakoStaminaPointsAttribute());
            m_attributes.Add(JakoAttributesEnum.Mana, new JakoManaPointsAttribute());
            m_attributes.Add(JakoAttributesEnum.BonusPhysResist, new JakoResistPhysicalAttribute());
            m_attributes.Add(JakoAttributesEnum.BonusFireResist, new JakoResistFireAttribute());
            m_attributes.Add(JakoAttributesEnum.BonusColdResist, new JakoResistColdAttribute());
            m_attributes.Add(JakoAttributesEnum.BonusEnerResist, new JakoResistEnergyAttribute());
            m_attributes.Add(JakoAttributesEnum.BonusPoisResist, new JakoResistPoisonAttribute());
        }
