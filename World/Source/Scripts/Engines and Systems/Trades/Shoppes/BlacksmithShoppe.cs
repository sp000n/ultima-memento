	...
	public class BlacksmithShoppe : BaseShoppe
	{
		...
		public static string MakeThisTask()
		{
			...
			switch( Utility.RandomMinMax( 1, 86 ) )
			{
				...
				case 80: item = new Claymore(); break;
				case 81: item = new SpikedClub(); break;
				case 82: item = new LargeKnife(); break;
				case 83: item = new Hammers(); break;
				case 84: item = new ShortSword(); break;
				case 85: item = new SunShield(); break;
				case 86: item = new VirtueShield(); break;
			}
